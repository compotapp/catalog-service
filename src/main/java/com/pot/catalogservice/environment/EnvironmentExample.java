...
@Component
@ConfigurationProperties(prefix = "polar") // + этой аннотации в том, что она автоматически обновляет настройки через actuator и не надо ставить аннотацию @RefreshScope
